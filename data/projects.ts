...
export const projects: Project[] = [
  ...
  },
  {
    ...
    position: { x: 22, y: 32 },
    tier: 3,
    icon: '/icons/translate-practice.png',
    techStack: ['Next.js'],
    year: 2026,
  ...
  },
  {
    ...
    position: { x: 12, y: 48 },
    tier: 3,
    icon: '/icons/greek-word-explorer.png',
  ...
  },
  {
    ...
    position: { x: 25, y: 46 },
    tier: 3,
    icon: '/icons/n2-visual-vocab.png',
  ...
  },
  {
    ...
    position: { x: 82, y: 28 },
    tier: 2,
    icon: '/icons/ism-journey-map.png',
    techStack: ['Next.js'],
    year: 2025,
